...
namespace GCL
{
    ...
    {
        // heavily based on https://github.com/rvknth043/Global-Low-Level-Key-Board-And-Mouse-Hook/
        // only updated for C# 8+ (made with C# 10 i think.. lol)
        //
        // need to have a good look at this later to understand what's happening and change it up a bit
        // for now i just wanna mess with some games
